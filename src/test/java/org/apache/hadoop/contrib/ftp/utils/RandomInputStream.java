...
public class RandomInputStream extends InputStream {
	...
	/**
	 * Constructs a new InputStream, which will return the specified amount of bytes
	...
	/**
	 * Creates a new random input stream of specified length, and specifies whether
	 * the stream should be full on binary or character data.
	 *
